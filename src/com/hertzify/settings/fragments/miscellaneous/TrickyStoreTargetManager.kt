...
class TrickyStoreTargetManager(
    ...
    private val autoSelectPackages = setOf(
    ...
    companion object {
        private const val TAG = "TrickyStoreManager"
    ...
    private fun setupBottomSheet(dialog: BottomSheetDialog, themeContext: Context) {
    ...
    private fun createDivider(themeContext: Context): View {
    ...
    fun showTargetAppPicker() {
        scope.launch {
            ...
            setupBottomSheet(bottomSheetDialog, themeContext)

            val rootLayout = MaxHeightLinearLayout(context, 0.75f).apply {
            ...
            // Divider
            rootLayout.addView(createDivider(themeContext))
            ...
            autoButton.setOnClickListener {
                var changed = false
                autoSelectPackages.forEach { pkg ->
    ...
    private class MaxHeightLinearLayout @JvmOverloads constructor(
        context: Context,
        private val maxHeightRatio: Float = 0.75f
